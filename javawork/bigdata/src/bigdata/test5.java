...
public class test5 {
	...
	public static void main(String[] args) throws IOException{
		...
		{
			int I=1;
			BufferedReader in=new BufferedReader(new FileReader("F://»º´æÇø//in.csv"));
			//BufferedWriter ot=new BufferedWriter(new FileWriter("F://»º´æÇø//out.csv"));
			FileOutputStream fos = new FileOutputStream("F://»º´æÇø//out.csv");  
			...
			while((s1=in.readLine())!=null)
			{
				...
				else
				{
					...
					while(ind!=-1)
					{
						...
						if(ind==0)
						{
							ind=s1.indexOf("Ôª",ind+2);
							continue;
						}
						String w=s4.substring(ind-ind_s-1, ind-ind_s);
						if(w.equals("ÃÀ")||func2(w));
						else
						{
							ind=s1.indexOf("Ôª",ind+2);
							continue;
	...
	public static boolean func(String s) throws IOException
	{
		...
		BufferedReader bin=new BufferedReader(new FileReader("F://»º´æÇø//book.txt"));
	...
	public static boolean func2(String s)
	{
		if(s.equals(".")||s.equals("£¬"))
			...
			return true;
		else if(s.equals("Áã")||s.equals("©–")||s.equals("O")||s.equals("o"))
			return true;
		else if(s.equals("Ò»")||s.equals("¶þ")||s.equals("Èý")||s.equals("ËÄ")||s.equals("Îå")||s.equals("Áù")||s.equals("Æß")||s.equals("°Ë")||s.equals("¾Å")||s.equals("Ê®")||s.equals("°Ù")||s.equals("Ç§")||s.equals("Íò"))
			return true;
		else if(s.equals("Ò¼")||s.equals("·¡")||s.equals("Èþ")||s.equals("ËÁ")||s.equals("Îé")||s.equals("Â½")||s.equals("Æâ")||s.equals("°Æ")||s.equals("¾Á")||s.equals("Ê°")||s.equals("°Û")||s.equals("Çª")||s.equals("Ç§"))
			return true;
		else
			return false;
	...
	public static String func3(String s)
	{
		...
		if(s.endsWith("Íò"))
			s=s+"0000";
		if(s.endsWith("Ç§")||s.endsWith("Çª"))
			s=s+"000";
		if(s.endsWith("°Ù")||s.endsWith("°Û"))
			s=s+"00";
		if(s.endsWith("Ê®")||s.endsWith("Ê°"))
			s=s+"0";
		//////////////////////////////////////////
		s=s.replace("Íò", "");
		s=s.replace("Ç§", "");
